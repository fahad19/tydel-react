...
/***/ function(module, exports, __webpack_require__) {
	...
	function connect(mapModelToProps) {
	  return function (ContainerComponent) {
	    var displayName = ContainerComponent.displayName || ContainerComponent.name || 'Component';
	    ...
	    var WrappedComponent = _react2.default.createClass({
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        this.modelWatcher = this.context.model.on('change', function () {
	          _this.updateStateFromModel();
	        });
	      },
	      ...
	      render: function render() {
	        var containerProps = this.state.containerProps;


	        return _react2.default.createElement(ContainerComponent, containerProps);
	      }
	    });
